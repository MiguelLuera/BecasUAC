<%@ Page Title="FAQ" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FAQ.aspx.cs" Inherits="Fron_End.FAQ" %>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="text-center pt-15">
                <h1 class="font-weight-bolder text-white mb-6">FAQ - Preguntas Frecuentes</h1>
                <div class="row">
            ...
            <div class="accordion accordion-solid accordion-panel accordion-svg-toggle mb-10" id="faq">
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading1">
                        <div class="card-title font-size-h4 text-dark" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1" role="button">
                            <div class="card-label">¿Cuál es el plazo para enviar solicitudes de becas?</div>
                    ...
                    <div id="faq1" class="collapse show" aria-labelledby="faqHeading1" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">
                            Se aceptará el envío de becas académicas entre el 14 de agosto y el 05 de setiembre del 2020.
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading2">
                        <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq2" aria-expanded="false" aria-controls="faq2" role="button">
                            <div class="card-label">¿Cuántas solicitudes de becas pueden enviarse?</div>
                            <span class="svg-icon svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div id="faq2" class="collapse" aria-labelledby="faqHeading2" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">
                            Cada estudiante puede realizar una única solicitud de beca por semestre. El sistema no aceptará una segunda solicitud de beca.
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading3">
                        <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq3" aria-expanded="false" aria-controls="faq3" role="button">
                            <div class="card-label">¿Cuáles son los requisitos para una solicitud de beca?</div>
                            <span class="svg-icon svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div id="faq3" class="collapse" aria-labelledby="faqHeading3" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">
                            Los requisitos de las solicitudes varían según el tipo de beca al cual desea postular. Puede ver un listado de ellos en el siguiente  <a href="https://www.uandina.edu.pe/descargas/becas/ordinario2020II/3-REQUISITOS-BECA-ORDINARIAS-TODOS.pdf" target="_blank">enlace</a>
                        </div>
                    </div>
                    <!--end::Body-->
                </div>
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading4">
                        <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq4" aria-expanded="false" aria-controls="faq4" role="button">
                            <div class="card-label">¿Cómo consigo la constancia de notas y constancia de matrícula?</div>
                            <span class="svg-icon svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div id="faq4" class="collapse" aria-labelledby="faqHeading4" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">Usted puede encontrar estos documentos accediendo con su correo institucional en el sistema ERP de la Universidad Andina del Cusco, accesible desde el siguiente <a href="https://erp.uandina.edu.pe/" target="_blank">enlace</a>. Debe acceder a la sección de reportes, gestión académica, reportes por alumno y elegir los documentos.</div>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Item-->
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading5">
                        <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq5" aria-expanded="false" aria-controls="faq5" role="button">
                            <div class="card-label">¿Cuáles son los criterios que se usan para aprobar una beca?</div>
                            <span class="svg-icon svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div id="faq5" class="collapse" aria-labelledby="faqHeading5" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">Para que una solicitud de beca sea aceptada, todos los documentos solicitados deben estar en orden. Los demás criterios para aceptar una solicitud de beca dependen del tipo de beca al cual postuló. Por ejemplo, para acceder a una beca por excelencia académica, usted debe ocupar uno de los primeros lugares en el ránking académico de su escuela profesional. Puede consultar esta información en este <a href="https://www.uandina.edu.pe/descargas/becas/ordinario2020II/11-R_CU-542-2019-UAC-reglamento-becasordinarias.pdf" target="_blank">documento</a></div>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Item-->
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading6">
                        <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq6" aria-expanded="false" aria-controls="faq6" role="button">
                            <div class="card-label">¿Cómo se realiza el pago de derecho a trámite administrativo?</div>
                            <span class="svg-icon svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div id="faq6" class="collapse" aria-labelledby="faqHeading6" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">El pago se realiza en las agencias de la Caja Municipal Cusco y Credinka. El documento que debe adjuntar al realizar una solicitud de beca es un escaneo del voucher del pago.</div>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Item-->
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading7">
                        <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq7" aria-expanded="false" aria-controls="faq7" role="button">
                            <div class="card-label">¿Cómo realizo el pago para el seguro de accidente estudiantil?</div>
                            <span class="svg-icon svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div id="faq7" class="collapse" aria-labelledby="faqHeading7" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">El pago de este seguro se hace durante las fechas que indica la universidad para el pago de matrículas. Se puede hacer de manera extemporánea, pero debe tener el visto bueno del departamento de Bienestar Universitario. Contacte con el departamento para ello.</div>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Item-->
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading8">
                        <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq8" aria-expanded="false" aria-controls="faq8" role="button">
                            <div class="card-label">¿Cómo puedo conocer el estado de mi solicitud de beca?</div>
                            <span class="svg-icon svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div id="faq8" class="collapse" aria-labelledby="faqHeading8" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">Puede acceder a la información de tu solicitud en esta página web en la sección "Mi solicitud". También recibirá un correo electrónico si el estado de tu solicitud de beca ha cambiado.</div>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Item-->
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading9">
                        <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq9" aria-expanded="false" aria-controls="faq9" role="button">
                            <div class="card-label">¿Cómo subsano las observaciones hechas a mi solicitud de beca?</div>
                            <span class="svg-icon svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div id="faq9" class="collapse" aria-labelledby="faqHeading9" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">Cuando un documento es observado, usted tendrá la opción de subir un archivo nuevo con las correcciones. Puede ver qué documentos tienen observaciones en la esta <a href="RevisionSolicitud.aspx" target="_blank">documento</a></div>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Item-->
                ...
                <div class="card p-6">
                    ...
                    <div class="card-header" id="faqHeading10">
                        <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq10" aria-expanded="false" aria-controls="faq10" role="button">
                            <div class="card-label">¿Cómo puedo saber el estado de mi solicitud?</div>
                            <span class="svg-icon svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div id="faq10" class="collapse" aria-labelledby="faqHeading10" data-parent="#faq">
                        <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">
                            Puedes ir al siguiente <a href="RevisionSolicitud.aspx" target="_blank">link</a> en el cuál verás uno de los siguientes estados: <br /> 
                            <div class="row">
                                <div class="col-lg-1">
                                    <span class="label label-inline label-light-primary font-weight-bold">Analizando</span>
                                </div>
                                <div class="col-lg-11">
                            ...
                            <div class="row">
                                <div class="col-lg-1">
                                    <span class="label label-inline label-light-danger font-weight-bold">Denegado</span>
                                </div>
                                <div class="col-lg-11">
                                    Su solicitud fue denegada por algún motivo, si desea contactar con algún personal de Bienestar Universitario envíe un correo a jsantos@uandina.edu.pe
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-1">
                                    <span class="label label-inline label-light-warning font-weight-bold">Observado</span>
                                </div>
                                <div class="col-lg-11">
                                    Su solicitud tiene algún documento pendiente de subsanación.
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-1">
                                    <span class="label label-inline label-light-info font-weight-bold">Revisado</span>
                                </div>
                                <div class="col-lg-11">
                                    Su solicitud fue revisada y todos los documentos cumplen con los requisitos.
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-1">
                                    <span class="label label-inline label-light-success font-weight-bold">Aprobado</span>
                                </div>
                                <div class="col-lg-11">
                                    Su solicitud fue elegida para ser beneficiada con una beca.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card card-custom p-6 mb-8 mb-lg-0">
                <div class="card-body d-flex align-items-center justify-content-between">
                    <!--begin::Content-->
                    <div class="mr-4">
                        <h3 class="text-dark mb-6">¿No encontraste la respuesta que deseas?</h3>
                        <p class="text-dark-50 font-size-lg">
                            La UNIVERSIDAD ANDINA DEL CUSCO tiene sus preguntas frecuentes, quizás tengas más suerte ahí.
                        </p>
                    </div>
                    <!--end::Content-->
                    <!--begin::Button-->
                    <a href="https://www.uandina.edu.pe/index.php/preguntas-frecuentes/" class="btn font-weight-bolder text-uppercase font-size-lg btn-primary py-3 px-6" target="_blank">MÁS RESPUESTAS</a>
                    <!--end::Button-->
                </div>
            </div>
            <!--end:: content-->
