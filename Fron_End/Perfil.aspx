<%@ Page Title="PERFIL" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Perfil.aspx.cs" Inherits="Fron_End.Perfil" %>
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                <div class="navi-item mb-2">
                                    <a href="Perfil.aspx" class="navi-link py-4 active">
                        ...
                        <form class="form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <asp:TextBox id="txtNombres" runat="server" class="form-control form-control-lg form-control-solid" type="text" ReadOnly/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Apellidos</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <asp:TextBox id="txtApellidos" runat="server" class="form-control form-control-lg form-control-solid" type="text" ReadOnly/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">DNI</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <asp:TextBox id="txtDNI" runat="server" class="form-control form-control-lg form-control-solid" type="text" ReadOnly/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Dirección</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <asp:TextBox id="txtDireccion" runat="server" class="form-control form-control-lg form-control-solid" type="text" ReadOnly/>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-xl-3"></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group input-group-lg input-group-solid">
                                            ...
                                            <asp:TextBox id="txtTelefono" runat="server" class="form-control form-control-lg form-control-solid" type="text" ReadOnly/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group input-group-lg input-group-solid">
                                            ...
                                            <asp:TextBox id="txtEmail" runat="server" class="form-control form-control-lg form-control-solid" type="text" ReadOnly/>
                                        </div>
                                    </div>
                                </div>
                            </div>
